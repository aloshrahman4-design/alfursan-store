...
5) لكل سعر وجدته (dozen_price و/أو single_price)، حدّد أيضاً صندوق إحاطة (bounding box)
   ...
   مهم جداً: إن كان الرقم محاطاً بقوسين "(" و ")" ملاصقين له مباشرة بلا مسافة واضحة تفصل
   بينهما، وسِّع حدود الصندوق ليشمل القوسين أيضاً -- لأنهما سيُمحيان مع الرقم عند التعديل
   ولن يبقيا ظاهرين في الصورة المعدَّلة (لا تُدرج رمز القوس نفسه كجزء من القيمة الرقمية
   بالطبع). وبالمثل، إن وُجد رقم غريب ملاصق مباشرة (كما في القاعدة 4g) بحيث تلامس حافته
   حافة رقم السعر تقريباً بلا مسافة واضحة تفصل بينهما، وسِّع الصندوق ليشمله أيضاً -- لكن
   لا تُدرج قيمته ضمن الرقم نفسه.
