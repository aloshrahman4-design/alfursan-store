...
5) لكل سعر وجدته (dozen_price و/أو single_price)، حدّد أيضاً صندوق إحاطة (bounding box)
   حول أرقام ذلك السعر -- بدون رمز العملة، بدون الأقواس، بدون كلمة الوصف المجاورة له --
   بمقياس 0 إلى 1000 نسبةً لأبعاد الصورة الكاملة، بالترتيب: y_min (الحافة العلوية)،
   x_min (الحافة اليسرى)، y_max (الحافة السفلية)، x_max (الحافة اليمنى). ضعه في
   dozen_price_bbox أو single_price_bbox المقابل. إن وُجد رقم غريب ملاصق مباشرة (كما في
   القاعدة 4g) بحيث تلامس حافته حافة رقم السعر تقريباً بلا مسافة واضحة تفصل بينهما، وسِّع
   حدود الصندوق ليشمله أيضاً (لأنه سيُغطّى بصريًا مع السعر) -- لكن لا تُدرج قيمته ضمن
   الرقم نفسه. إن لم تستطع تحديد الموقع بدقة كافية، اترك حقل الـ bbox فارغاً حتى لو أعطيت
   الرقم نفسه في الحقل الرقمي.
"""
