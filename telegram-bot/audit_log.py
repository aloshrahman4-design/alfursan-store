"""Append-only audit trail: one JSON line per published item.
...
bot's whole point is a handful of admins publishing a modest number of
...
def record(entry: Dict[str, Any]) -> None:
    ...
    try:
        ...
        logger.exception("Failed to write audit log entry (publish still succeeded)")
